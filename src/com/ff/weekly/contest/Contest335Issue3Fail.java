 ...
 * 20230309 this solution is time exceeding
 */
public class Contest335Issue3Fail {
    public static void main(String[] args) {
//        System.out.println(new Contest335Issue3().findValidSplitOther(new int[]{4, 7, 8, 15, 3, 5}));
        System.out.println(new Contest335Issue3Fail().findValidSplitOther(new int[]{4, 7, 16, 15, 3, 5}));
